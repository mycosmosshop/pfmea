...
export const SvgIconRenderer: React.FC<{ svgString: string; className?: string }> = ({ svgString, className }) => (
    <div className={className} dangerouslySetInnerHTML={{ __html: svgString }} />
);

export const SpinnerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg className="animate-spin h-3.5 w-3.5 mr-1.5 inline-block align-text-bottom" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
